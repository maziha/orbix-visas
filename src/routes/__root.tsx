...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Orbix is India's most trusted Study Abroad & Immigration consultancy. 150,000+ success stories across Canada, Australia, UK, Germany & more." },
      ...
      { property: "og:description", content: "Study Abroad & Migration experts — 17+ years, 100+ partner universities, 99.87% success rate." },
