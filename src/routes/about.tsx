    ...
    <SiteLayout>
      ...
      <section className="py-20">
        <div className="container-px mx-auto max-w-4xl prose-lg space-y-6 text-foreground">
          ...
          <p className="text-muted-foreground leading-relaxed">{COMPANY_NAME} was founded with one mission — to be a trusted bridge between Indian aspirants and global opportunities. We are building our practice on transparency, careful preparation, and counsellors who take the time to understand your goals before recommending a path forward.</p>
