  ...
  return (
    <section className="relative py-20 md:py-28 bg-[var(--navy)] text-white overflow-hidden">
      ...
      <div className="container-px mx-auto max-w-7xl relative">
        ...
        <h1 className="font-display text-4xl md:text-6xl mt-3 leading-tight max-w-3xl">{title}</h1>
        {subtitle && <p className="text-white/80 mt-4 max-w-2xl text-lg">{subtitle}</p>}
      </div>
    </section>
  );
}