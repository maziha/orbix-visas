    ...
    <section className="family-highlight-section bg-brand-subtle py-16 md:py-20">
      <div className="container-px mx-auto max-w-7xl">
        <div className="flex flex-col overflow-hidden rounded-2xl border border-[#e4e8f0] lg:flex-row lg:min-h-[28rem]">
          <div className="family-highlight-section__copy lg:w-[55%] px-6 py-12 md:px-10 md:py-16 lg:px-12">
          ...
          <p className="mt-4 text-sm">
            <Link to="/services" hash="family-visa" className="text-[var(--accent-sky)] font-semibold hover:underline">
              Compare all family visa guides →
            </Link>
          </p>
          </div>

          <div className="family-highlight-section__panel lg:w-[45%] bg-[var(--accent-sky)] px-6 py-10 md:px-10 md:py-14 flex flex-col justify-center gap-4">
          {FAMILY_VISA_SLUGS.map((slug) => {
            ...
            return (
              ...
              >
                ...
                <span className="family-visa-panel-card__arrow shrink-0 text-xl font-semibold text-[var(--accent-sky)] transition-transform duration-200 group-hover:translate-x-0.5">
                  →
                </span>
              </Link>
            );
